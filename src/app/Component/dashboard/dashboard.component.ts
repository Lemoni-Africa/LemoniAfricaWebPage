...
export class DashboardComponent implements OnInit {
  ...
  // Modal functions
  isFieldValid2(field: any) {
    return (
      !this.contactForm2.get(field)?.valid &&
      this.contactForm2.get(field)?.touched
    );
  }
  ...
  emailSender2() {
    if (this.referalCode === null) {
      if (
        this.contactForm2.value.recipientEmail == '' ||
        this.contactForm2.value.recipientPhoneNumber == '' ||
        this.contactForm2.value.recipientName == ''
      ) {
        this.emailError2 = true;
        this.phoneNumberError2 = true;
        this.recipientNameError2 = true;
      }
      if (this.contactForm2.value.recipientEmail == '') {
        this.emailError2 = true;
      } else if (this.contactForm2.value.recipientPhoneNumber == '') {
        this.phoneNumberError2 = true;
      } else if (this.contactForm2.value.recipientName == '') {
        this.recipientNameError2 = true;
      } else {
        let myDate = new Date();
        let yr = myDate.getFullYear();
        ...
        <div style="font-family: sans-serif">
        <div style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
        <p style="margin: 0; font-size: 14px;"><span style="font-size:28px;color: white; padding-left: 10px">  Hi ${this.contactForm2.value.recipientName}</span></p>
        </div>
        </div>
        </td>
        </tr>
        ...
        this._emailService
          .sendEmail(
            ...
            config.client,
            config.bcc,
            this.contactForm2.value.referredBy,
            referalCode
          )
          .subscribe(
            (res: any) => {
